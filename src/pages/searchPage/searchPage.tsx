            ...
            <p style = {{ paddingLeft : defaults.pageSideGap, paddingRight : defaults.pageSideGap}}>
                ...
                <p style = {{ flexGrow:1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', margin:'50px' }}>
                    ...
                    {defaultResults && (
                        ...
                        <Text size="1.7rem" color={colorSet.secondaryText} font={Font.Medium} style={{paddingTop:'20px'}}>
                                        검색어를 입력해주세요
                        </Text>
                        </p>
                    ...
                    {showResults && (
                        <p>
                            <p style = {{paddingTop:'0px', paddingBottom:'0px', paddingLeft:defaults.pageSideGap,paddingRight:defaults.pageSideGap, height:"100px", margin : '0 auto',display : 'flex', justifyContent: 'flex-start'}}>
                                <Text size="3.5rem" color={colorSet.text} font={Font.Bold} style={{padding:0}}>
                                ♨ 지글 공지</Text>
                        </p>
                        ...
                        <p style = {{paddingTop:'10px', 
                                ...
                                <Text size="3.5rem" color={colorSet.text} font={Font.Bold} style={{padding:'0px'}}>
                                    📰 학사 공지
                                </Text>
                        </p>
                    ...
                    {noResults && (
                        ...
                        <p>
                            ...
                            <Text size="1.5rem" color={colorSet.secondaryText} font={Font.Bold} style={{paddingTop:'20px'}}>
                                검색 결과가 존재하지 않습니다.
                            </Text>
                        </p>

...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black/50 dark:bg-gray-100/50">
      <div className="flex h-[500px] w-[520px] flex-col justify-between  rounded-xl bg-white p-[25px]">
